            ...
            <ul class="ps-0">
                @if($user->follower)
                    <li class="d-flex justify-content-center">
                        <p class="text-secondary display-6">Follower</p>
                    </li>
                @else
                    <li class="d-flex justify-content-center">
                        <p class="text-secondary fs-4">No followers Yet!!</p>
                    </li>
                @endif
                @foreach ($user->follower as $follower)
                        <li class="d-flex justify-content-between align-items-center mt-3">
                            <div class="d-flex align-items-center">
                                <a href="{{ route('profile.show', $follower->follower ) }}" class="">
                                ...
                                <a href="{{ route('profile.show', $follower->follower->id ) }}" class="text-decoration-none text-black ms-2 mb-0">{{ $follower->follower->name }}</a>
                            </div>
